...
![Version: 0.1.0](https://img.shields.io/badge/Version-0.1.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2023.11.1](https://img.shields.io/badge/AppVersion-2023.11.1-informational?style=flat-square)
...
```console
$ helm repo add benji-charts https://chartmuseum.newbenji.dk/
$ helm install my-release benji-charts/home-assistant
```
...
| hadbconfig | string | `"postgresql://homeassistant:****@postgresql.localhost/homeassistant"` |  |
| homeAssistant.persistence.volumeName | string | `"pvc-6fa054bc-a616-473a-ba1d-4925c832fb33"` |  |
...
| postgresql.connection | string | `"postgresql://homeassistant:theise8aeGephuuChiTh@postgresql-service.pg.svc.cluster.local/homeassistant"` |  |
...
""
		...
		<tr>
			...
			<td>string</td>
			<td><pre lang="json">
"postgresql://homeassistant:****@postgresql.localhost/homeassistant"
</pre>
</td>
			<td></td>
		</tr>
		<tr>
			...
			<td>string</td>
			<td><pre lang="json">
"pvc-6fa054bc-a616-473a-ba1d-4925c832fb33"
</pre>
</td>
			<td></td>
		</tr>
...
{}
		...
		<tr>
			...
			<td>string</td>
			<td><pre lang="json">
"postgresql://homeassistant:theise8aeGephuuChiTh@postgresql-service.pg.svc.cluster.local/homeassistant"
</pre>
</td>
			<td></td>
		</tr>
